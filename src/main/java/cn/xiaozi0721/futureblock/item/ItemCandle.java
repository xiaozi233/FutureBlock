...
public class ItemCandle extends ItemBlock {
        ...
        if (!itemstack.isEmpty() && player.canPlayerEdit(pos, facing, itemstack)) {
            ...
            if (isCandle) {
                ...
                if (i==0){
                    ...
                    int candleCakeID = Block.getIdFromBlock(BlocksRegister.CANDLE_CAKE);
                    getIdFromItem(itemstack.getItem());
    ...
    public boolean canPlaceBlockOnSide(World world, BlockPos pos, EnumFacing side, EntityPlayer player, ItemStack stack) {
        ...
        return block instanceof BlockCake && state.getValue(BlockCake.BITES) == 0|| block instanceof BlockCandle && ((Integer) state.getValue(BlockCandle.CANDLES)) <= 3 || super.canPlaceBlockOnSide(world, pos, side, player, stack);
    }
